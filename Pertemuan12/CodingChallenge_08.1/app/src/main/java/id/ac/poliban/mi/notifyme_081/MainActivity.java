package id.ac.poliban.mi.notifyme_081;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION =
            id.ac.poliban.mi.notifyme_081.BuildConfig.APPLICATION_ID + ".ACTION_CANCEL_NOTIFICATION";
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.notifyme_081.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMe!-Tesa");
